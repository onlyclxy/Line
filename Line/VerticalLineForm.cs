...
namespace Line
{
    public class VerticalLineForm : Form
    {
        ...
        private Dictionary<int, Form> verticalLines = new Dictionary<int, Form>();
        ...
        private void AddVerticalLineMenuItems()
        {
            ...
            ToolStripMenuItem verticalLineMenu = new ToolStripMenuItem("竖线设置");
            ...
            var mousePenetrationItem = new ToolStripMenuItem("鼠标穿透", null, (s, e) => {
                ...
                {
                    int exStyle = GetWindowLong(line.Handle, GWL_EXSTYLE);
                    SetWindowLong(line.Handle, GWL_EXSTYLE, mouseClickThrough ? 
        ...
        private void UpdateHotkeyMenuCheckedState()
        {
            ...
            {
                if (item is ToolStripMenuItem menuItem && menuItem.Text == "竖线设置")
                {
        ...
        private void UpdateMenuCheckedState(string menuName, Func<ToolStripMenuItem, bool> checkCondition)
        {
            ...
            foreach (ToolStripItem item in trayIcon.ContextMenuStrip.Items)
            {
                if (item is ToolStripMenuItem verticalMenu && verticalMenu.Text == "竖线设置")
                {
        ...
        private void ShowVerticalLine(int index)
        {
            ...
            else
            {
                ...
                {
                    int exStyle = GetWindowLong(line.Handle, GWL_EXSTYLE);
                    SetWindowLong(line.Handle, GWL_EXSTYLE, exStyle | WS_EX_TRANSPARENT);
                }
